...
class TypeOfStudy(models.Model):
    ...
    stemmed = models.CharField(max_length=360, blank=True)
    created_on = models.DateTimeField(auto_now_add=True)
    updated_on = models.DateTimeField(auto_now=True)
...
class DeviceType(models.Model):
    ...
    device_type_stemmed = models.CharField(max_length=360, blank=True)
    device_maker_stemmed = models.CharField(max_length=360, blank=True)
    created_on = models.DateTimeField(auto_now_add=True)
    updated_on = models.DateTimeField(auto_now=True)
